...
public class StudentApp {
    ...
    public static void main(String[] args) {
        ...
        Student second = new Student("Elek", "Víz", 19);
        ...
        boolean isFirstnameEquals = firstFirstName.equals(secondLastName);
        System.out.println("A két keresztnév megegyezik: " + isFirstnameEquals);
